...
<form  onSubmit={handleSubmit} className="newItem">
  ...
  <input id="date" value={transaction.date} name="date" 
  ...
  <input id="name" value={transaction.name} name="name" 
  ...
  <input 
  id="amount" value={transaction.amount} name="amount" 
  type="number" placeholder="amount" onChange={addTransaction, handleTextChange}/>
  </div>
  ...
  <br />
  <input id="from" name="from" value={transaction.from}
